...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Print Styles */
        @media print {
            .filter-card, .btn, .header p, .expand-btn {
                display: none;
            }
    ...
    <div class="container">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                <h3>Total Reports</h3>
                <div class="summary-amount"><?= count($records) ?></div>
                <p>Cash-up submissions</p>
            </div>
            
            <div class="summary-card">
                <h3>Total Revenue</h3>
                <div class="summary-amount">$<?= number_format($totalRevenue, 2) ?></div>
                <p>Grand total revenue</p>
            </div>
            
            <div class="summary-card">
                <h3>Total Cash In</h3>
                <div class="summary-amount">$<?= number_format($totalCash, 2) ?></div>
                <p>Cash received</p>
            </div>
